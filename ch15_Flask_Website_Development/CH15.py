...
#
# @app.route('/')
# @app.route('/index')     #網頁路徑 : '/' or '/index' 都會執行 index function
# def index():
#     return '這是本網站首頁!'
#
# if __name__ == '__main__':
...
# app = Flask(__name__)
#
# @app.route("/hello/<string:name>")  # <string:name> 傳參數
# def hello(name):
...
# < / html >
#
# # 8 (15-3) Template 語言(網頁語法): Template 組成---------------------------------
# # (1)變量 :{{username}}
